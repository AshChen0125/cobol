       ...
       FILE-CONTROL.
           ...
           SELECT OUT-FILE ASSIGN TO 'test_0925.txt' 
               ORGANIZATION IS LINE SEQUENTIAL.
                       ...
                       REMAINING)) = 0
                           ...
                           *> TOKEN ≤ 35 且含 KEYWORD → 直接輸出
                           ...
                           <= 35 AND FOUND = 'Y'
                               ...
                               TEMP-FIELD
                               STRING TEMP-FIELD DELIMITED BY SIZE '|' 
                               DELIMITED BY SIZE
                               ...
                               PERFORM UNTIL TMP-POS > PART-LEN
                                   ...
                                   IF LOC-FOUND = 'Y'
                                       ...
                                       *> 輸出 LOCATION 本身
                                       ...
                                       PERFORM VARYING IDX FROM 
                                       FILL-START-IDX BY 1 UNTIL IDX > 
                                       35
                                           MOVE SPACE TO FIELD-FILL
                                           (IDX:1)
                                       END-PERFORM
